...
-- MAGIC %python
-- MAGIC dtb = delta.tables.DeltaTable.forPath(spark, "dbfs:/mnt/dbacademy-users/tomas.zitka@datasentics.com/data-engineer-learning-path/database.db/students")

-- COMMAND ----------

-- MAGIC %python
-- MAGIC display(dtb.detail())
