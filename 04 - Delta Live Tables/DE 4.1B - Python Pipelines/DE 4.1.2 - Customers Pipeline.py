...
# all Data Quality Expectation Rules an Data Quality Expectation Policies require DLT Advanced, c.f. https://www.databricks.com/product/pricing/delta-live
@dlt.table
@dlt.expect_or_fail("valid_id", "customer_id IS NOT NULL") # no syntax check, no type control, no debugging, just run it and hope for the best
...
@dlt.expect_or_drop("valid_email", """
    ...
    operation = "DELETE"
    """) # yeah I'm sure, this will work no problem first try
...
# Change Data Capture (CDC) requires DLT Pro, c.f. https://www.databricks.com/product/pricing/delta-live
